      ...
      <section class="rounded-sm border border-ui-border bg-ui-surface/30 p-4 space-y-4">
        <div class="flex items-start justify-between gap-3">
          <div class="space-y-1">
            ...
            <div class="flex items-start gap-1.5 text-[12px] text-ui-text-muted leading-relaxed">
              <span>填写一个 OpenAI-compatible 服务，系统会自动拉取模型列表。未配置时使用默认能力。</span>
              <span class="relative group shrink-0">
                <button
                  type="button"
                  aria-label="查看默认能力说明"
                  class="rounded-full p-0.5 text-ui-text-muted/70 hover:text-ui-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ui-accent"
                >
                ...
                >
                  默认能力来自内置 Cursor 路径。某些场景会额外打开一个独立窗口。
                </span>
              </span>
            </div>
          </div>
