...
**验证/视觉/下载（9）：** `browser_verify`, `get_page_metadata`, `highlight_element`, `highlight_text_inline`, `capture_screenshot`, `capture_tab_screenshot`, `capture_screenshot_with_highlight`, `download_image`, `download_chat_images`
